--//========================================================
--// TUYEN MOD - ULTRA FIX LAG & ANTI-DROWN ICE WATER (FULL)
...
local Settings = {
    FreezeWater = true,     -- Đóng băng biển (Chống dìm) đưa lên ưu tiên
    Particles = true,       -- Xóa 100% hiệu ứng VFX
    LowMaterial = true,     -- Làm nhẵn vật thể
    RemoveWater = true,     -- Ẩn mặt biển
    Shadows = true,         -- Tắt bóng
    Lights = true,          -- Tắt đèn
    Textures = true,        -- Tắt Decal/Texture
...
--========================================================
-- OPTIMIZATION ENGINE (XÓA 100% HIỆU ỨNG VFX & LÀM NHẴN)
--========================================================
...
local function ProcessObject(Object)
    pcall(function()
        ...
        -- XÓA 100% HIỆU ỨNG (PARTICLES, BEAMS, TRAILS, FIRE, SMOKE, SKILL VFX, POST-EFFECTS...)
...
--========================================================
-- TAB 1: TỐI ƯU FPS (CÓ CHỨC NĂNG ĐÓNG BĂNG MẶT BIỂN Ở ĐẦU)
--========================================================
...
-- ĐÃ ĐƯA ĐÓNG BĂNG LÊN ĐẦU DANH SÁCH TỐI ƯU FPS
local TogglesList = {
...
--========================================================
-- TAB 2: DI CHUYỂN & CẤU HÌNH SPEED/JUMP
--========================================================
...
--========================================================
-- ENGINE SÀN BĂNG VÀ LOOP CHỐNG DÌM / CHỐNG TRÔI
--========================================================

local WATER_LEVEL = 0
local IceFloor = Instance.new("Part")
IceFloor.Name = "TuyenMod2194_AntiDrownIceFloor"
IceFloor.Size = Vector3.new(3000, 20, 3000) -- Sàn băng siêu rộng & dày 20 studs
...
-- DÙNG RENDERSTEPPED ĐỂ FIX CHẠY NHANH CỰC MẠNH (KHÔNG CHO GAME ĐÈ LẠI TỐC ĐỘ)
RunService.RenderStepped:Connect(function()
    pcall(function()
        ...
        -- 1. FIX DỨT ĐIỂM CHẠY NHANH KHÔNG BỊ LỖI
        if Hum then
...
-- VÔ HIỆU HÓA SÁT THƯƠNG NƯỚC GÂY DAME
task.spawn(function()
...
-- Tự động áp dụng tối ưu sau khi inject
RefreshAllObjects()