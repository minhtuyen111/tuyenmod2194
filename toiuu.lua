--//========================================================
--// TUYEN MOD - ULTRA FIX LAG & ANTI-DROWN ICE WATER (FULL INFO FIX)
...
--========================================================
-- TAB 3: THÔNG TIN (FIXED DISPLAY & ADDED ALL COPY BUTTONS)
--========================================================

TabInfo.CanvasSize = UDim2.new(0, 0, 0, 480)

local AboutCard = Instance.new("Frame")
AboutCard.Size = UDim2.new(1, -12, 0, 310)
...
CreateCopyButton("📋 SAO CHÉP LINK DISCORD CÀY THUÊ", INFO.Discord, 326, COLOR_ACCENT)
CreateCopyButton("▶️ SAO CHÉP LINK KÊNH YOUTUBE", INFO.YouTube, 364, Color3.fromRGB(220, 50, 50))
CreateCopyButton("🎵 SAO CHÉP LINK TIKTOK", INFO.TikTok, 402, Color3.fromRGB(40, 40, 40))
