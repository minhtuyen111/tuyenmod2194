...
--// FONT: BuilderSans | DRAGGABLE & 5S INTRO & SERVICE PROMO
--//========================================================
...
local function ShowToast(Text)
    ...
    task.delay(1.8, function()
        ...
        if Token == ToastToken meAN Toast.Visible = false end
    end)
end
...
--========================================================
-- TAB 3: THÔNG TIN (ĐÃ BỔ SUNG VĂN BẢN VÀ CÀY THUÊ PROMO)
--========================================================
...
AboutText.TextSize = 8.5
ApplyFont(AboutText)
AboutText.TextXAlignment = Enum.TextXAlignment.Left
AboutText.TextYAlignment = Enum.TextYAlignment.Top
AboutText.TextWrapped = true
AboutText.Text = [[TUYEN MOD – ULTRA FIX LAG & BẢO HÀNH TRẢI NGHIỆM
