...
local function ShowToast(Text)
    ...
    task.delay(1.8, function()
        if Token ~= ToastToken me then return end
...
--========================================================
-- ENGINE XÓA SƯƠNG MÙ HOÀN TOÀN (NO FOG NEW REWRITE)
--========================================================

local function RemoveFogEngine()
    pcall(function()
        if Settings.ClearFog then
            -- Tắt các thiết lập sương mù cơ bản
            Lighting.FogStart = 9999999
            Lighting.FogEnd = 9999999
            Lighting.GlobalShadows = false
            
            -- Xóa/Tắt tất cả Atmosphere và các Effect trong Lighting
...
-- Loop tự động duy trì Xóa Sương Mù
...
--========================================================
-- ENGINE SÀN BĂNG VÀ XÓA LỖI ĐỎ MÀN HÌNH CHUẨN
--========================================================
...
RunService.RenderStepped:Connect(function()
    pcall(function()
        ...
        -- XÓA LỖI MÀN HÌNH ĐỎ BLOX FRUITS TỰ ĐỘNG
        for _, gui in ipairs(PlayerGui:GetChildren()) do
            if gui.Name:lower():find("water") or gui.Name:lower():find("damage") or gui.Name:lower():find("red") or gui.Name:lower():find("screen") then
        ...
        if Settings.FreezeWater and Root and Hum then
            ...
            -- Nâng cao vị trí sàn lên hẳn 5 studs trên mực nước để chân nhân vật không dính nước
