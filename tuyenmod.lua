--//========================================================
--// TUYEN MOD - ULTRA FIX LAG & ANTI-FOG / ANTI-DARKNESS
--// SAFE EXECUTION | DRAGGABLE | 5S INTRO | FULL INFO FIX
--//========================================================
...
-- BẢNG CÀI ĐẶT TÍNH NĂNG (MẶC ĐỊNH OFF)
local Settings = {
    FreezeWater = false,    -- Đóng băng biển
    ClearFog = false,       -- Xóa sương mù & Siêu sáng map / Chống tối
...
--========================================================
-- OPTIMIZATION ENGINE & ANTI-FOG / ANTI-DARKNESS
--========================================================
...
local function ApplyGlobalLighting()
    pcall(function()
        -- TÍNH NĂNG XÓA SƯƠNG MÙ & SÁNG MAP
        if Settings.ClearFog then
            Lighting.FogStart = 9e9
            Lighting.FogEnd = 9e9
            Lighting.Brightness = 2
            Lighting.ClockTime = 14 -- Ép trời ban ngày sáng tỏ
            Lighting.GlobalShadows = false
            Lighting.Ambient = Color3.fromRGB(255, 255, 255)
            Lighting.OutdoorAmbient = Color3.fromRGB(255, 255, 255)
            
            -- Tắt các effect làm tối/mờ/choáng màn hình
            for _, v in ipairs(Lighting:GetChildren()) do
                if v:IsA("PostEffect") or v:IsA("Atmosphere") or v:IsA("ColorCorrectionEffect") or v:IsA("BlurEffect") then
                    v.Enabled = false
                end
            end
        else
...
local TogglesList = {
    ...
    {"☀️ Xóa Sương Mù & Sáng Map", "Nhìn rõ mọi đảo, xóa hiệu ứng mờ/tối", "ClearFog"},
...
--========================================================
-- TAB 3: THÔNG TIN (UI UIListLayout CHUẨN KÍCH THƯỚC - ĐẢM BẢO KHÔNG BỊ HIỂN THỊ LỖI)
--========================================================
...
CreateInfoLine("☀️ Xóa sương mù, làm sáng map & xóa hiệu ứng tối màn hình.", 9, COLOR_TEXT_SUB, 12)
CreateInfoLine("🧊 Sàn băng đóng băng biển siêu dày, chống dìm an toàn.", 9, COLOR_TEXT_SUB, 13)
